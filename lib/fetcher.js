...
exports.createExif = (pack, auth) =>{
    ...
    const exif = {"sticker-pack-id": "com.client.tech", "sticker-pack-name": pack, "sticker-pack-publisher": auth, "android-app-store-link": "pekok", "ios-app-store-link": "yahahhaa"}
